              ...
              {currentStep === 4 && (
                <div className="bg-white rounded-3xl p-12 shadow-sm text-center">
                  ...
                  {bookingResult?.bookingId && (
                    <div className="mb-6">
                      <a
                        href={`/api/invoice/${bookingResult.bookingId}`}
                        download
                        className="inline-flex items-center gap-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-full px-6 py-3 font-medium transition-all"
                      >
                  ...
                  <div className="flex flex-col gap-4 max-w-md mx-auto mb-6">
                    <Link
                      href={`/payment?booking_id=${bookingResult?.bookingId}&amount=${totalPrice}`}
                      className="flex items-center justify-center gap-3 bg-[#af4b32] hover:bg-[#af4b32]/90 text-white rounded-full px-8 py-4 font-medium transition-all"
                    >
                    ...
                    <a
                      ...
                      className="flex items-center justify-center gap-3 bg-[#25D366] hover:bg-[#25D366]/90 text-white rounded-full px-8 py-4 font-medium transition-all"
                    >
                  ...
                  <Link href="/" className="text-[#af4b32] hover:underline inline-block">
                    العودة للرئيسية
                  </Link>
                </div>
              )}
